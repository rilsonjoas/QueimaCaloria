...
public class InicializadorDados {
    ...
    public static void inicializarDados() throws TreinoNaoEncontradoException {
        ...
        // Dietas
        try {
            Dieta dieta1 = new Dieta("Dieta para Emagrecimento Rápido", Dieta.ObjetivoDieta.PERDA_DE_PESO, 1200, new HashMap<>(), null, null);
            repositorioDietas.adicionar(dieta1);
            Dieta dieta2 = new Dieta("Dieta Low Carb Moderada", Dieta.ObjetivoDieta.PERDA_DE_PESO, 1600, new HashMap<>(), null, null);
            repositorioDietas.adicionar(dieta2);
            Dieta dieta3 = new Dieta("Dieta da Proteína", Dieta.ObjetivoDieta.GANHO_DE_MASSA, 2500, new HashMap<>(), null, null);
            repositorioDietas.adicionar(dieta3);
            Dieta dieta4 = new Dieta("Dieta Vegana para Atletas", Dieta.ObjetivoDieta.GANHO_DE_MASSA, 2700, new HashMap<>(), null, null);
            repositorioDietas.adicionar(dieta4);
            Dieta dieta5 = new Dieta("Dieta Mediterrânea", Dieta.ObjetivoDieta.MANUTENCAO, 2000, new HashMap<>(), null, null);
            repositorioDietas.adicionar(dieta5);
            Dieta dieta6 = new Dieta("Dieta sem Glúten e Lactose", Dieta.ObjetivoDieta.MANUTENCAO, 2200, new HashMap<>(), null, null);
            repositorioDietas.adicionar(dieta6);
            Dieta dieta7 = new Dieta("Dieta para Ganho de Massa Muscular", Dieta.ObjetivoDieta.GANHO_DE_MASSA, 3000, new HashMap<>(), null, null);
            repositorioDietas.adicionar(dieta7);
            Dieta dieta8 = new Dieta("Dieta Flexível para Definição", Dieta.ObjetivoDieta.PERDA_DE_PESO, 1700, new HashMap<>(), null, null);
            repositorioDietas.adicionar(dieta8);
            Dieta dieta9 = new Dieta("Dieta para Iniciantes", Dieta.ObjetivoDieta.MANUTENCAO, 1900, new HashMap<>(), null, null);
            repositorioDietas.adicionar(dieta9);
            Dieta dieta10 = new Dieta("Dieta Personalizada do Cliente", Dieta.ObjetivoDieta.MANUTENCAO, 2400, new HashMap<>(), null, null);
            repositorioDietas.adicionar(dieta10);


        } catch (DietaNaoEncontradaException e) {
            System.err.println("Erro ao adicionar dieta: " + e.getMessage());
        }


        // Exercícios
        try {
            Exercicio exercicio1 = new Exercicio("Agachamento Livre", "Exercício básico para pernas e glúteos com barra nas costas.", null, Exercicio.TipoExercicio.FORCA, 30, 9.0, false, 0);
            repositorioExercicios.adicionar(exercicio1);
            Exercicio exercicio2 = new Exercicio("Supino Reto com Barra", "Exercício para peitoral e tríceps com barra.", null, Exercicio.TipoExercicio.FORCA, 30, 8.5, false, 0);
            repositorioExercicios.adicionar(exercicio2);
            Exercicio exercicio3 = new Exercicio("Remada Curvada com Barra", "Exercício para costas e bíceps com barra.", null, Exercicio.TipoExercicio.FORCA, 30, 7.0, false, 0);
            repositorioExercicios.adicionar(exercicio3);
            Exercicio exercicio4 = new Exercicio("Desenvolvimento Militar com Halteres", "Exercício para ombros com halteres.", null, Exercicio.TipoExercicio.FORCA, 30, 7.0, false, 0);
            repositorioExercicios.adicionar(exercicio4);
            Exercicio exercicio5 = new Exercicio("Flexão de Braço", "Exercício para peitoral, ombros e tríceps.", null, Exercicio.TipoExercicio.FORCA, 30, 6.5, false, 0);
            repositorioExercicios.adicionar(exercicio5);
            Exercicio exercicio6 = new Exercicio("Barra Fixa Pegada Pronada", "Exercício para costas e bíceps com barra fixa.", null, Exercicio.TipoExercicio.FORCA, 30, 8.0, false, 0);
            repositorioExercicios.adicionar(exercicio6);
            Exercicio exercicio7 = new Exercicio("Prancha Abdominal", "Exercício para fortalecimento do core.", null, Exercicio.TipoExercicio.FORCA, 60, 4.0, false, 0);
            repositorioExercicios.adicionar(exercicio7);
            Exercicio exercicio8 = new Exercicio("Caminhada na Esteira Inclinada", "Exercício aeróbico de caminhada com inclinação.", null, Exercicio.TipoExercicio.CARDIO, 20, 6.0, false, 0);
            repositorioExercicios.adicionar(exercicio8);
            Exercicio exercicio9 = new Exercicio("Corrida na Rua", "Exercício aeróbico de corrida ao ar livre.", null, Exercicio.TipoExercicio.CARDIO, 30, 9.0, false, 0);
            repositorioExercicios.adicionar(exercicio9);
            Exercicio exercicio10 = new Exercicio("Pular Corda", "Exercício aeróbico e de coordenação com corda.", null, Exercicio.TipoExercicio.CARDIO, 15, 10.0, false, 0);
            repositorioExercicios.adicionar(exercicio10);
            Exercicio exercicio11 = new Exercicio("Natação Livre", "Exercício aeróbico de natação em piscina.", null, Exercicio.TipoExercicio.AQUATICO, 40, 10.0, false, 0);
            repositorioExercicios.adicionar(exercicio11);
            Exercicio exercicio12 = new Exercicio("Yoga para Flexibilidade", "Exercício para melhorar a flexibilidade e o equilíbrio.", null, Exercicio.TipoExercicio.FLEXIBILIDADE, 40, 4.0, false, 0);
            repositorioExercicios.adicionar(exercicio12);
            Exercicio exercicio13 = new Exercicio("Pilates para Core", "Exercício para fortalecer o core e melhorar a postura.", null, Exercicio.TipoExercicio.EQUILIBRIO, 45, 5.0, false, 0);
            repositorioExercicios.adicionar(exercicio13);
            Exercicio exercicio14 = new Exercicio("Spinning", "Exercício aeróbico em bicicleta estacionária.", null, Exercicio.TipoExercicio.CARDIO, 45, 8.0, false, 0);
            repositorioExercicios.adicionar(exercicio14);
            Exercicio exercicio15 = new Exercicio("Elíptico", "Exercício aeróbico de baixo impacto em elíptico.", null, Exercicio.TipoExercicio.CARDIO, 30, 7.0, false, 0);
            repositorioExercicios.adicionar(exercicio15);
            Exercicio exercicio16 = new Exercicio("Treino Funcional", "Treino que combina diferentes exercícios em circuito.", null, Exercicio.TipoExercicio.OUTRO, 60, 6.0, false, 0);
            repositorioExercicios.adicionar(exercicio16);
            Exercicio exercicio17 = new Exercicio("Burpees", "Exercício que trabalha o corpo todo.", null, Exercicio.TipoExercicio.FORCA, 20, 10.0, false, 0);
            repositorioExercicios.adicionar(exercicio17);
            Exercicio exercicio18 = new Exercicio("Polichinelo", "Exercício aeróbico simples.", null, Exercicio.TipoExercicio.CARDIO, 15, 5.0, false, 0);
            repositorioExercicios.adicionar(exercicio18);
            Exercicio exercicio19 = new Exercicio("Corda Naval", "Exercício de força e resistência com corda naval.", null, Exercicio.TipoExercicio.FORCA, 20, 9.0, false, 0);
            repositorioExercicios.adicionar(exercicio19);
            Exercicio exercicio20 = new Exercicio("Abdominal Supra", "Exercício para abdominais superiores.", null, Exercicio.TipoExercicio.FORCA, 20, 3.0, false, 0);
            repositorioExercicios.adicionar(exercicio20);

        } catch (ExercicioNaoEncontradoException e) {
            System.err.println("Erro ao adicionar exercício: " + e.getMessage());
        }
        ...
        try {
            ...
            repositorioRefeicoes.adicionar(refeicao1);
            ...
            repositorioRefeicoes.adicionar(refeicao2);
            ...
            repositorioRefeicoes.adicionar(refeicao3);
            ...
            repositorioRefeicoes.adicionar(refeicao4);
            ...
            repositorioRefeicoes.adicionar(refeicao5);
            ...
            repositorioRefeicoes.adicionar(refeicao6);
            ...
            repositorioRefeicoes.adicionar(refeicao7);
            ...
            repositorioRefeicoes.adicionar(refeicao8);
            ...
            repositorioRefeicoes.adicionar(refeicao9);
            ...
            repositorioRefeicoes.adicionar(refeicao10);
            ...
            repositorioRefeicoes.adicionar(refeicao11);
            ...
            repositorioRefeicoes.adicionar(refeicao12);
            ...
            repositorioRefeicoes.adicionar(refeicao13);
            ...
            repositorioRefeicoes.adicionar(refeicao14);
            ...
            repositorioRefeicoes.adicionar(refeicao15);
            ...
            repositorioRefeicoes.adicionar(refeicao16);
            ...
            repositorioRefeicoes.adicionar(refeicao17);
            ...
            repositorioRefeicoes.adicionar(refeicao18);
            ...
            repositorioRefeicoes.adicionar(refeicao19);
            ...
            repositorioRefeicoes.adicionar(refeicao20);
            ...
            repositorioRefeicoes.adicionar(refeicao21);
            ...
            repositorioRefeicoes.adicionar(refeicao22);
            ...
            repositorioRefeicoes.adicionar(refeicao23);
            ...
            repositorioRefeicoes.adicionar(refeicao24);
            ...
            repositorioRefeicoes.adicionar(refeicao25);
            ...
            repositorioRefeicoes.adicionar(refeicao26);
            ...
            repositorioRefeicoes.adicionar(refeicao27);
            ...
            repositorioRefeicoes.adicionar(refeicao28);
            ...
            repositorioRefeicoes.adicionar(refeicao29);
            ...
            repositorioRefeicoes.adicionar(refeicao30);
            ...
            repositorioRefeicoes.adicionar(refeicao31);
            ...
            repositorioRefeicoes.adicionar(refeicao32);
            ...
            repositorioRefeicoes.adicionar(refeicao33);
            ...
            repositorioRefeicoes.adicionar(refeicao34);
            ...
            repositorioRefeicoes.adicionar(refeicao35);
            ...
            repositorioRefeicoes.adicionar(refeicao36);
            ...
            repositorioRefeicoes.adicionar(refeicao37);
            ...
            repositorioRefeicoes.adicionar(refeicao38);
            ...
            repositorioRefeicoes.adicionar(refeicao39);
            ...
            repositorioRefeicoes.adicionar(refeicao40);
            ...
            repositorioRefeicoes.adicionar(refeicao41);
            ...
            repositorioRefeicoes.adicionar(refeicao42);
            ...
            repositorioRefeicoes.adicionar(refeicao43);
            ...
            repositorioRefeicoes.adicionar(refeicao44);
            ...
            repositorioRefeicoes.adicionar(refeicao45);
            ...
            repositorioRefeicoes.adicionar(refeicao46);
            ...
            repositorioRefeicoes.adicionar(refeicao47);
            ...
            repositorioRefeicoes.adicionar(refeicao48);
            ...
            repositorioRefeicoes.adicionar(refeicao49);
            ...
            repositorioRefeicoes.adicionar(refeicao50);
            ...
            repositorioRefeicoes.adicionar(refeicao51);
            ...
            repositorioRefeicoes.adicionar(refeicao52);
            ...
            repositorioRefeicoes.adicionar(refeicao53);
            ...
            repositorioRefeicoes.adicionar(refeicao54);
            ...
            repositorioRefeicoes.adicionar(refeicao55);
            ...
            repositorioRefeicoes.adicionar(refeicao56);
            ...
            repositorioRefeicoes.adicionar(refeicao57);
            ...
            repositorioRefeicoes.adicionar(refeicao58);
            ...
            repositorioRefeicoes.adicionar(refeicao59);
            ...
            repositorioRefeicoes.adicionar(refeicao60);
            ...
            repositorioRefeicoes.adicionar(refeicao61);
            ...
            repositorioRefeicoes.adicionar(refeicao62);
            ...
            repositorioRefeicoes.adicionar(refeicao63);
            ...
            repositorioRefeicoes.adicionar(refeicao64);
            ...
            repositorioRefeicoes.adicionar(refeicao65);
            ...
            repositorioRefeicoes.adicionar(refeicao66);
            ...
            repositorioRefeicoes.adicionar(refeicao67);
            ...
            repositorioRefeicoes.adicionar(refeicao68);
            ...
            repositorioRefeicoes.adicionar(refeicao69);
            ...
            repositorioRefeicoes.adicionar(refeicao70);
            ...
            repositorioRefeicoes.adicionar(refeicao71);
            ...
            repositorioRefeicoes.adicionar(refeicao72);
            ...
            repositorioRefeicoes.adicionar(refeicao73);
            ...
            repositorioRefeicoes.adicionar(refeicao74);
            ...
            repositorioRefeicoes.adicionar(refeicao75);
            ...
            repositorioRefeicoes.adicionar(refeicao76);
            ...
            repositorioRefeicoes.adicionar(refeicao77);
            ...
            repositorioRefeicoes.adicionar(refeicao78);
            ...
            repositorioRefeicoes.adicionar(refeicao79);
            ...
            repositorioRefeicoes.adicionar(refeicao80);
            ...
            repositorioRefeicoes.adicionar(refeicao81);
            ...
            repositorioRefeicoes.adicionar(refeicao82);
            ...
            repositorioRefeicoes.adicionar(refeicao83);
            ...
            repositorioRefeicoes.adicionar(refeicao84);
            ...
            repositorioRefeicoes.adicionar(refeicao85);
            ...
            repositorioRefeicoes.adicionar(refeicao86);

        } catch (Exception e) {
            System.err.println("Erro ao adicionar refeição: " + e.getMessage());
        }
        ...
        repositorioTreinos.adicionar(treino1);
        ...
        repositorioTreinos.adicionar(treino2);
        ...
        repositorioTreinos.adicionar(treino3);
        ...
        repositorioTreinos.adicionar(treino4);
        ...
        repositorioTreinos.adicionar(treino5);
        ...
        repositorioTreinos.adicionar(treino6);
        ...
        repositorioTreinos.adicionar(treino7);
        ...
        repositorioTreinos.adicionar(treino8);
        ...
        repositorioTreinos.adicionar(treino9);
        ...
        repositorioTreinos.adicionar(treino10);
        ...
        repositorioTreinos.adicionar(treino11);
        ...
        repositorioTreinos.adicionar(treino12);
        ...
        repositorioTreinos.adicionar(treino13);
        ...
        repositorioTreinos.adicionar(treino14);
        ...
        repositorioTreinos.adicionar(treino15);
    }
}