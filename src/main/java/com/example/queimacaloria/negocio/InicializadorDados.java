...
public class InicializadorDados {
    ...
    public static List<Treino> inicializarTreinos() {
        ...
        treino1.setTipoDeTreino(Exercicio.TipoExercicio.FORCA);
        ...
        treino2.setTipoDeTreino(Exercicio.TipoExercicio.FORCA);
        ...
        treino3.setTipoDeTreino(Exercicio.TipoExercicio.RESISTENCIA);
        ...
        treino4.setTipoDeTreino(Exercicio.TipoExercicio.RESISTENCIA);
        ...
        treino5.setTipoDeTreino(Exercicio.TipoExercicio.FORCA);
        ...
        treino6.setTipoDeTreino(Exercicio.TipoExercicio.FORCA);
        ...
        treino7.setTipoDeTreino(Exercicio.TipoExercicio.CARDIO);
        ...
        treino8.setTipoDeTreino(Exercicio.TipoExercicio.CARDIO);
        ...
        treino9.setTipoDeTreino(Exercicio.TipoExercicio.FLEXIBILIDADE);
        ...
        treino10.setTipoDeTreino(Exercicio.TipoExercicio.EQUILIBRIO);
        ...
        treino11.setTipoDeTreino(Exercicio.TipoExercicio.AQUATICO);
        ...
        treino12.setTipoDeTreino(Exercicio.TipoExercicio.CARDIO);
        ...
        treino13.setTipoDeTreino(Exercicio.TipoExercicio.OUTRO);
        ...
        treino14.setTipoDeTreino(Exercicio.TipoExercicio.FORCA);
        ...
        treino15.setTipoDeTreino(Exercicio.TipoExercicio.CARDIO);
