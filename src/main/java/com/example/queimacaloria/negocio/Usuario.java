...
public class Usuario {
    ...
    @Setter private Sexo sexo;
    @Setter private float peso;
    @Setter private float altura;
    @Setter private float imc;
    @Setter private ArrayList<Meta> metas;
    @Setter private ArrayList<Treino> treinos;
    @Setter private ArrayList<Dieta> dietas;
